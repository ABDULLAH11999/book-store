    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-4">
      <form onSubmit={onSubmit} className="w-full max-w-md rounded-[2rem] border border-black/10 bg-black p-8 text-white shadow-2xl">
        <div className="flex items-center gap-3">
          <Image src={BRAND_LOGO_PATH} alt={`${BRAND_NAME} logo`} width={56} height={56} className="h-12 w-12 object-contain" priority />
          <h1 className="font-heading text-4xl text-white">{BRAND_NAME} Admin</h1>
        </div>
