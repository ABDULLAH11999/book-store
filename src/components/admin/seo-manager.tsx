...
const defaultSeo = {
  ...
  metaDescription: "IslamicPlay is an online Islamic bookstore for Quran, Urdu Islamic books, and meaningful gifts in Pakistan.",
  canonicalUrl: "",
  metaKeywords: "IslamicPlay, Islamic books, Quran, Urdu books, Islamic bookstore Pakistan, buy Quran online, Islamic gifts, Quran shop",
  ogTitle: BRAND_NAME,
  ogDescription: "IslamicPlay is an online Islamic bookstore for Quran, Urdu Islamic books, and meaningful gifts in Pakistan.",
  ogImage: "",
  headerScripts: "",
  footerScripts: "",
  robotsTxt: ""
