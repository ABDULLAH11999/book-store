...
import { BRAND_LOGO_PATH, BRAND_NAME, BRAND_TAGLINE } from "@/lib/branding";
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          ...
          />
          <span>
            <span className="block font-heading text-xl font-semibold tracking-wide text-ink">{BRAND_NAME}</span>
            <span className="block text-xs uppercase tracking-[0.3em] text-brown">{BRAND_TAGLINE}</span>
          </span>
        </Link>
