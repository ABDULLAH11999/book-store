...
export function ProductCard({
  ...
  const image = normalizeMediaUrl(product.images?.[0] || "/books/asan-tarjuma-quran-1.webp");
  const hoverImage = useMemo(
    () => normalizeMediaUrl(product.images?.[1] || product.images?.[0] || "/books/asan-tarjuma-quran-1.webp"),
    [product.images]
  );
