...
export async function POST(request: Request) {
  ...
  await sendMail({
    ...
    html: `<div style="font-family:Arial,sans-serif;padding:24px"><h1>IslamicPlay</h1><p>This message was resent from the admin panel.</p><p>Template: ${log.template}</p></div>`,
